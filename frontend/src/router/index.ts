...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      {
        path: '',
        name: 'ExpectationsHome',
        component: () => import('@/views/Expectations/index.vue'),
        meta: { title: '预期管理', requiresAuth: true }
      }
    ]
  },
  {
    path: '/index-prediction',
    name: 'IndexPrediction',
    component: () => import('@/layouts/BasicLayout.vue'),
    meta: {
      title: '指数预测',
      icon: 'TrendCharts',
    ...
    children: [
      {
        path: '',
        name: 'IndexPredictionHome',
        component: () => import('@/views/IndexPrediction/index.vue'),
        meta: { title: '指数预测', requiresAuth: true }
      },
      {
        path: 'history',
        name: 'IndexPredictionHistory',
        component: () => import('@/views/IndexPrediction/History.vue'),
        meta: { title: '预测历史', requiresAuth: true }
      },
      {
        path: 'tasks',
        name: 'IndexPredictionTasks',
        component: () => import('@/views/IndexPrediction/Tasks.vue'),
