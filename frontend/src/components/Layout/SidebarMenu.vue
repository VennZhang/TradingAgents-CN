<template>
  ...
  >
    ...
    <el-menu-item index="/expectations">
      <el-icon><Edit /></el-icon>
      <template #title>预期管理</template>
    </el-menu-item>

    <el-sub-menu index="/index-prediction">
      <template #title>
        <el-icon><TrendCharts /></el-icon>
        <span>指数预测</span>
      </template>
      <el-menu-item index="/index-prediction">指数分析</el-menu-item>
      <el-menu-item index="/index-prediction/tasks">任务管理</el-menu-item>
      <el-menu-item index="/index-prediction/history">预测历史</el-menu-item>
    </el-sub-menu>
